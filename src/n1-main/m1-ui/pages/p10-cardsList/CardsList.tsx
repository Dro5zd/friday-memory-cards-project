            ...
            <div className={s.components}>
                <div className={s.packSide}>
                    <div className={s.arrowWrapper}>
                        <img onClick={goBackHandler} className={s.arrowLeft}
                             src={mode ? arrowLeftBlackWhite : arrowLeftWhite}
                             alt="arrowLeft"/>
                    </div>
                    ...
                    <div className={s.searchContainer}>
                        ...
                        {isOwner &&
                            <SuperButton className={s.searchButton} onClick={addNewCard} title={'Add new card'}/>}
                    </div>
